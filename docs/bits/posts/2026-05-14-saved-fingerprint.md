...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="Saved Fingerprint">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/d64f03f" target="_blank" rel="noopener" class="story-gen-link">
    gen:d64f03f
  </a>
</div>
