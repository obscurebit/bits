...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="Bench Warrant Bowling">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/ef6b9a5" target="_blank" rel="noopener" class="story-gen-link">
    gen:ef6b9a5
  </a>
</div>
