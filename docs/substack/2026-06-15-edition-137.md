---
title: "Obscure Bit #137: The Tare-Meter’s Complaint"
subtitle: "Daily discoveries from the hidden corners of the internet • June 15, 2026"
date: 2026-06-15
edition: 137
---

*Edition #137 • June 15, 2026*
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="The Tare-Meter’s Complaint">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/db30f01" target="_blank" rel="noopener" class="story-gen-link">
    gen:db30f01
  </a>
</div>
