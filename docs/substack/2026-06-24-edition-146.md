---
title: "Obscure Bit #146: The Last Claim Drawer"
subtitle: "Daily discoveries from the hidden corners of the internet • June 24, 2026"
date: 2026-06-24
edition: 146
---

*Edition #146 • June 24, 2026*
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="The Last Claim Drawer">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/4557c4b" target="_blank" rel="noopener" class="story-gen-link">
    gen:4557c4b
  </a>
</div>
