---
title: "Obscure Bit #141: The Residual Registry"
subtitle: "Daily discoveries from the hidden corners of the internet • June 19, 2026"
date: 2026-06-19
edition: 141
---

*Edition #141 • June 19, 2026*
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="The Residual Registry">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/b38d8ae" target="_blank" rel="noopener" class="story-gen-link">
    gen:b38d8ae
  </a>
</div>
