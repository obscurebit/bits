...
All generated outputs go under `book/output/volume-1/`, which is ignored by Git:
...
Tracked book source assets live under `book/source/volume-1/assets/`:

- `book/source/volume-1/assets/art/`
- `book/source/volume-1/assets/modes/`
- `book/source/volume-1/assets/sections/`

Private local-only inputs belong under `private/`, which is ignored by Git:
...
3. Move the final selected slugs into `book/source/volume-1/manifest.yaml` under `selected_entries`.
4. Generate or manually create art from `book/output/volume-1/art-briefs.yaml`.
5. Record approved final art in `book/source/volume-1/art_manifest.yaml`.
6. Finalize `book/source/volume-1/creator-note.md`.
7. Finalize `book/source/volume-1/machines-note.md`.
8. Finalize `book/source/volume-1/editor-letter.md`.
