...
class PrepareQueueTests(unittest.TestCase):
    def test_prepare_date_sets_reliable_story_defaults(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(captured["env"]["OPENAI_REQUEST_TIMEOUT"], "240")
            self.assertEqual(captured["env"]["OPENAI_COMPLETION_ATTEMPTS"], "3")
            ...
            self.assertEqual(captured["env"]["AI_STORY_VARIETY_TIMEOUT_SECONDS"], "45")
