---
date: 2026-05-30
title: "The Glove and the Glasshouse"
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="The Glove and the Glasshouse">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/f2de4e5" target="_blank" rel="noopener" class="story-gen-link">
    gen:f2de4e5
  </a>
</div>
