...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="The Greenhouse Receipt">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/c44397c" target="_blank" rel="noopener" class="story-gen-link">
    gen:c44397c
  </a>
</div>
